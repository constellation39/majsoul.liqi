...
class AccountActivityUpdate(_message.Message):
    __slots__ = ("mine_data", "rpg_data", "feed_data", "spot_data", "friend_gift_data", "upgrade_data", "gacha_data", "simulation_data", "combining_data", "village_data", "festival_data", "island_data", "story_data", "choose_up_data", "simulation_v2_data", "shoot_data")
...
class BillShortcut(_message.Message):
    ...
    count: int
    deal_price: int
    def __init__(self, id: _Optional[int] = ..., count: _Optional[int] = ..., deal_price: _Optional[int] = ...) -> None: ...
...
class ActivityShootData(_message.Message):
    __slots__ = ("activity_id", "level", "enemies", "rewarded_ids")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    LEVEL_FIELD_NUMBER: _ClassVar[int]
    ENEMIES_FIELD_NUMBER: _ClassVar[int]
    REWARDED_IDS_FIELD_NUMBER: _ClassVar[int]
...
class ResFetchManagerCustomizedContest(_message.Message):
    __slots__ = ("error", "name", "open_show", "game_rule_setting", "start_time", "end_time", "auto_match", "rank_rule", "check_state", "checking_name", "contest_setting", "rank_type")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    OPEN_SHOW_FIELD_NUMBER: _ClassVar[int]
    GAME_RULE_SETTING_FIELD_NUMBER: _ClassVar[int]
...
class ActionNewRound(_message.Message):
    __slots__ = ("chang", "ju", "ben", "tiles", "dora", "scores", "operation", "liqibang", "tingpais0", "tingpais1", "al", "md5", "left_tile_count", "doras", "opens", "muyu", "ju_count", "field_spell", "sha256", "yongchang", "salt_sha256")
    CHANG_FIELD_NUMBER: _ClassVar[int]
    JU_FIELD_NUMBER: _ClassVar[int]
    BEN_FIELD_NUMBER: _ClassVar[int]
    TILES_FIELD_NUMBER: _ClassVar[int]
    ...
    SALT_SHA256_FIELD_NUMBER: _ClassVar[int]
    chang: int
    ju: int
    ben: int
    tiles: _containers.RepeatedScalarFieldContainer[str]
...
class LiQiSuccess(_message.Message):
    __slots__ = ("seat", "score", "liqibang", "failed", "liqi_type_beishuizhizhan")
    SEAT_FIELD_NUMBER: _ClassVar[int]
    SCORE_FIELD_NUMBER: _ClassVar[int]
    LIQIBANG_FIELD_NUMBER: _ClassVar[int]
    FAILED_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, seat: _Optional[int] = ..., score: _Optional[int] = ..., liqibang: _Optional[int] = ..., failed: bool = ..., liqi_type_beishuizhizhan: _Optional[int] = ...) -> None: ...
...
class HuleInfo(_message.Message):
    __slots__ = ("hand", "ming", "hu_tile", "seat", "zimo", "qinjia", "liqi", "doras", "li_doras", "yiman", "count", "fans", "fu", "title", "point_rong", "point_zimo_qin", "point_zimo_xian", "title_id", "point_sum", "dadian", "baopai", "baopai_seats", "lines", "tianming_bonus", "baida_changed", "hu_tile_bai_da_changed")
    HAND_FIELD_NUMBER: _ClassVar[int]
    MING_FIELD_NUMBER: _ClassVar[int]
    HU_TILE_FIELD_NUMBER: _ClassVar[int]
    SEAT_FIELD_NUMBER: _ClassVar[int]
    ...
    HU_TILE_BAI_DA_CHANGED_FIELD_NUMBER: _ClassVar[int]
    hand: _containers.RepeatedScalarFieldContainer[str]
    ming: _containers.RepeatedScalarFieldContainer[str]
    hu_tile: str
    seat: int
